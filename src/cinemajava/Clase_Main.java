...
public class Clase_Main {
    ...
    public static void main(String[] args) {
        ...
        //Profesor, quise crear una pequeña interfaz, para darle la bienvenida al programa
        System.out.println("===================================");
        System.out.println("     ¡Bienvenidos a Cinepaz!      ");
        System.out.println("  Su servidor: Juan David :)      ");
        System.out.println(" P.D.: Me esforce mucho en esto :') ");
        System.out.println("===================================");
        /* 
        ...
        while (continuar.equals("si")) {
            // Mostrar requisitos de la película
            System.out.println("Requisitos de la pelicula:");
            System.out.println(pelicula.mostrarDetallesPelicula()); // Muestra detalles de la película
            System.out.println("Precio de la entrada: " + cine.getPrecioEntrada()); // Muestra el precio de la entrada
            ...
            // Mostrar la matriz de asientos actualizada
            cine.mostrarAsientos();
